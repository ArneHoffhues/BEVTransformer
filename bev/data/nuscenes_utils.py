...
NUSCENES_CAMERA_NAMES = ['CAM_FRONT', 'CAM_FRONT_LEFT', 'CAM_FRONT_RIGHT',
                'CAM_BACK_LEFT', 'CAM_BACK_RIGHT', 'CAM_BACK']


NUSCENES_PRIORS = {'drivable_area': 0.44679, 'ped_crossing': 0.02407,
                    'walkway': 0.14491, 'carpark': 0.02994, 'car': 0.02086, 
                    'truck': 0.00477, 'bus': 0.00156, 'trailer': 0.00189,
                    'construction_vehicle': 0.00084, 'pedestrian': 0.00119,
                    'motorcycle': 0.00019, 'bicycle': 0.00012, 'traffic_cone': 0.00031,
                    'barrier': 0.00176}


def iterate_nuscenes_samples(nuscenes, start_token):
